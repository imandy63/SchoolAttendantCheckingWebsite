...
const Search = () => {
    ...
    useEffect(() => {
        ...
        if (selectedType) {
            events = events.filter(event => event.description.includes(selectedType));
        }
                    ...
                    filteredEvents.map((event, index) => (
                        <div key={index} className={styles.eventCard}>
                            ...
                            <div className={styles.eventInfo}>
                                ...
                                <p><strong>Giờ:</strong> {event.time}</p>
                                <p><strong>Địa điểm:</strong> {event.location}</p>
                                <p><strong>Tham gia:</strong> {event.attendees}</p>
                            </div>
                            <div className={styles.eventActions}>
                                {event.registered ? (
                                    <button className={clsx(styles.btn, styles.btnRegistered)}>Đã đăng ký</button>
                                ) : (
                                    <button className={clsx(styles.btn, styles.btnRegister)}>Đăng ký</button>
                                )}
                            </div>
                        </div>
                    ))
