...
// Mock data
const dashboardData = [
  { id: "D001", hoat_dong: "Hoạt động thể thao", tong_so_thanh_vien: 100, tham_gia: 80 },
  { id: "D002", hoat_dong: "Hoạt động văn nghệ", tong_so_thanh_vien: 80, tham_gia: 60 },
  { id: "D003", hoat_dong: "Hoạt động học thuật", tong_so_thanh_vien: 50, tham_gia: 45 },
];
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="flex items-center bg-white rounded-lg shadow-md p-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-blue-600">{dashboardData.length}</h3>
          </div>
        </div>
        <div className="flex items-center bg-white rounded-lg shadow-md p-4">
      ...
      <div className="flex space-x-8 mb-6">
        <div className="bg-white rounded-lg shadow-lg p-6" style={{ width: "40%", height: "300px" }}>
          <Pie data={pieData} />
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6" style={{ width: "60%", height: "300px" }}>
          <Bar data={barData} />
        </div>
      </div>
